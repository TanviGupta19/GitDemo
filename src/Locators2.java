...
public class Locators2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Assertion to compare text comes after Login page
		//remove scope from tesng dependency
	...
	public static String getPassword(WebDriver driver) throws InterruptedException // static means it is part of main 
	{
		driver.get("https://rahulshettyacademy.com/locatorspractice/");
